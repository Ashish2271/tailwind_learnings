                ...
                <div className="container px-6 py-10 mx-auto">
                    <div className="lg:flex lg:items-center">
                        <div className="w-full space-y-12 lg:w-1/2 ">
                            <div>
                                <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">explore MyWeb3Gift with  <br /> Lots of Benefits</h1>
                            ...
                            <div className="md:flex md:items-start md:-mx-4">
                                <span className="inline-block p-2 text-red-500 bg-red-100 rounded-xl md:mx-4 dark:text-white dark:bg-red-500">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Unique & Personalized Gifts</h1>

                                    <p className="mt-3 text-gray-500 dark:text-gray-300">
                                    Make your gifts truly special by adding personal messages and images. Choose from a range of options, including digital frames, video prints, and physical cards. Whether it's a birthday, wedding, or any special occasion, our gifts are a delightful surprise.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Crypto Learning Path for All</h1>

                                    <p className="mt-3 text-gray-500 dark:text-gray-300">
                                    Gift the gift of knowledge with our 24-day crypto learning path. Perfect for friends and family who want to dip their toes into the world of crypto and blockchain. They'll gain practical insights, discover the magic of digital assets, and learn at their own pace.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">NFT Art and Gaming Adventure</h1>

                                    <p className="mt-3 text-gray-500 dark:text-gray-300">
                                    Delight recipients with NFT art and gaming characters as they progress through the learning journey. They'll get hands-on experience with blockchain technology, mint NFTs, and even receive exclusive perks. It's an educational and entertaining gift rolled into one.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                            <img className="w-[28rem] h-[28rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=755&q=80" alt="Benefits and Features" loading="lazy"/>
                        </div>
                    </div>
