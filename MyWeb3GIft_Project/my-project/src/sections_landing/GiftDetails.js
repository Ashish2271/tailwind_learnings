...
import { Crpto1,  Crpto2 ,  Crpto3 , Crpto4 } from '../assets/Images/index.js'
            ...
            <div className="relative mt-10 lg:-mx-4 relative-20 lg:mt-0 lg:col-start-1">
              <div className="relative space-y-4">
                <div className="flex items-end justify-center space-x-4 lg:justify-start">
                  <img className="w-32 rounded-lg shadow-lg md:w-56" width="200" src={Crpto1} alt="1" />
                  <img className="w-40 rounded-lg shadow-lg md:w-64" width="260" src={Crpto2} alt="2" />
                </div>
                <div className="flex items-start justify-center ml-12 space-x-4 lg:justify-start">
                  <img className="w-24 rounded-lg shadow-lg md:w-40" width="170" src={Crpto3} alt="3" />
                  <img className="w-32 rounded-lg shadow-lg md:w-56" width="200" src={Crpto4} alt="4" />
                </div>
              </div>
            </div>
          </div>
