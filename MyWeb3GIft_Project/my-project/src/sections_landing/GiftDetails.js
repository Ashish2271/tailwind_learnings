...
const GiftDetails = () => {
  return (
    <div className="flex flex-col sm:my-10 sm:mx-16 md:flex-row justify-center items-center p-6 bg-gray-100 rounded-3xl shadow-lg">
    {/* Left Section */}
    <div className="md:w-1/2 md:py-5 md:mx-20  mb-4 md:mb-0">
      {/* Insert Unsplash Images */}
    
      <div className="da relative flex max-sm:rounded-3xl  flex-col justify-center overflow-hidden bg-gray-100">
