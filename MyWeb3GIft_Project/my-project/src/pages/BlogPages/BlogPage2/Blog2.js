    ...
    <div className='mx-auto w-full leading-10 max-w-2xl'>
        ...
        <div className='flex text-xl  justify-center items-center flex-col'>
                    ...
                    <div>
                        ...
                        <h1>Transacting at no cost</h1>
                        <p className='py-1 font-semibold mx-auto'>
                    ...
                    <img src="" className='rounded-xl' alt="Web3 Onboarding Time" />
                </div> */}
                        ...
                        <p className='py-4 font-semibold mx-auto'>
                        ...
                        <h1>Personal progress with 5 minutes a day</h1>

                        <p className='py-4 font-semibold mx-auto'>Each door&#39;s content is designed to be easily digestible within a 5-minute window each day. We
                        ...
                        <p className='py-4 font-semibold mx-auto'>By the end of this journey, we believe users will possess more blockchain knowledge than 95% of the
                        ...
                        <p className='py-4 font-semibold mx-auto'>Many discuss crypto, but only a relatively small group has conducted a real transaction. Our users will
