...
<img src={Thumbnail} className=' object-fit w-full h-screen  ' alt="My web3 gift Thumbnail " loading="lazy"/>
  ...
  <div className="flex absolute inset-0   flex-col backdrop-blur-xl bg-white/30 items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
      <a href="./" className="flex items-center mb-6 text-3xl font-semibold text-gray-100 dark:text-white">
      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div>
                      ...
                      <input type="text" name="name"   value={user.name}    onChange={getUserData}  id="name" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Jacob" required=""/>
                  </div>
                  <div>
                      <label for="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Email</label>
                      <input type="email" name="email"  value={user.email} onChange={getUserData}  id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required=""/>
                  </div>
                  {/* <div>
