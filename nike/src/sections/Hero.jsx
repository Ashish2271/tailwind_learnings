...
const  [bigShoeImg , setBigShoeImg ] = useState(bigShoe1)
  ...
  return (
    ...
    <section
      id="home"
      className="max-container w-full flex xl:flex-row flex-col justify-center   min-h-screen ">
      {/* border-2 */}
      ...
      <div className="relative flex   justify-center items-center xl:min-h-screen max-xl:py-40  bg-primary bg-hero bg-cover bg-center  ">
        <img src={bigShoeImg} alt="shoe collection" width={1200} height={500} className="object-contain relative z-10" />
